  ...
  <div class="container px-5 pb-4">
    <div class="row px-4 mt-5">
      <div class="col-12 col-md-6">
        <div class="row">
          <h2 class="titulos">Our branches</h2>
        </div>
        <div class="row">
      ...
      <div class="col-12 col-md-4">
        ...
        <div class="row">
          <input type="text" name="" value="" placeholder="Your Name" style="min-width:100%;">
        </div>
        <div class="row text-muted mb-2 mt-4">
          E-Mail *
        </div>
        <div class="row">
          <input type="text" name="" value="" placeholder="Your e-mail" style="min-width:100%;">
        </div>
        <div class="row text-muted mb-2 mt-4">
          Company
        </div>
        <div class="row">
          <input type="text" name="" value="" placeholder="Your company name" style="min-width:100%;">
        </div>
        <div class="row text-muted mb-2 mt-4">
          Subject
        </div>
        ...
        <div class="row mt-3">
          <button class="btn btn-primary py-3" type="button" name="button" style="min-width:100%;">Send</button>
        </div>
        </form>
      </div>
    </div>
