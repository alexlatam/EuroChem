...
<body style="background-color:#ffffff;">
  ...
  <div class="container px-5">
    <div class="row px-4 mt-3">
      <div class="col-12">
        <div class="row">
          <h2 class="titulos col-12 text-center">POLÍTICA DE QUEJAS Y RECLAMOS</h2>
        </div>
        <div class="row mt-2">
          <p class="text_general">
            Con el fin de mantener un alto nivel de servicio a nuestros clientes,
            Eurochem ha establecido en este documento las políticas generales
            para la realización y atención de Sugerencias, Quejas y Reclamos en la compañía.
            <br>
            La comunicación con Eurochem se puede hacer por cualquiera de los
            canales habilitados para el cliente, de acuerdo a lo informado por el
            representante de venta que los atiende.
          </p>
        </div>
        <div class="row">
          <h2 class="titulos col-12 text-center">1. DIRECTRICES GENERALES APLICADAS A LA PRESTACIÓN DEL SERVICIO Y ATENCIÓN DE INCONFORMIDADES DEL CLIENTE.</h2>
        </div>
        <div class="row mt-4">
          <p class="text_general">
            La compañía tiene como directriz entregar productos en sacos, tambores, IBC,
            cilindros, garrafas, cuñetes, tanques móviles y carrotanques en buen estado,
            con etiqueta, con una correcta identificación del contenido, el peso bruto, el
            peso neto, el número de lote, la fechas de producción y vencimiento (si aplica)
            y la identificación de peligrosidad (si aplica).
          </p>
          <p class="text_general">
            Los pesos de los embalajes / empaques son controlados con básculas de clase
            de precisión III (divisiones de escala de 50g, 100 g y 200g de acuerdo al peso
            individual) las cuales están sometidos a un estricto control metrológico,
            manteniendo vigente su estado de calibración y evidenciando la trazabilidad
            de su medición a patrones nacionales.
          </p>
          <p class="text_general">
            La compañía contrata el servicio de transporte, acogiendo los requerimientos
            de la legislación nacional para el transporte de mercancías, mercancías
            peligrosas y productos para alimentos. Para la contratación se realiza una
            selección y evaluación de proveedores que nos permite controlar la prestación
            del servicio.
          </p>
          <p class="text_general">
            Eurochem registra las fechas de realización del pedido, despacho y entrega
            de los productos que suministra, con el fin de controlar posibles desviaciones
            presentadas antes, durante y después de la prestación del servicio
          </p>
          <p class="text_general">
            Todos los despachos realizados por Eurochem van acompañados por su
            respectiva documentación: factura o remisión, plan de transporte y certificado
            de análisis, en algunos casos se anexan también los siguientes documentos:
            Certificado CCITE, tarjeta de emergencia, remisión préstamo de empaque,
            tiquete de báscula, carta de alimentos (para productos grado alimento que
            no son empleados para consumo humano). Estos documentos son entregados y
            revisados en los puntos de recepción del cliente.
          </p>
          <p class="text_general">
            Para la verificación de las cantidades, se acepta que exista una diferencia
            hasta del ±0.5 % entre la cantidad anunciada en la etiqueta del empaque y el
            resultado del pesaje realizado por el cliente. Lo anterior en razón de la
            diferencia en la calibración y capacidad de medición de las básculas y el
            personal que las opera.
          </p>
          <p class="text_general">
            Eurochem cuenta con un laboratorio de Control de Calidad, la compañía
            evaluará los productos objeto de una reclamación antes de aceptar la
            devolución que por conceptos de especificaciones técnicas este realizado
            el cliente.
          </p>
          <p class="text_general">
            Toda devolución a realizar, deberá ser previamente informada al
            representante de ventas para su comunicación y gestión al interior de Eurochem.
          </p>
          <p class="text_general">
            <strong>Motivos para la no aceptación de un Reclamo:</strong>
          </p>
          <p class="text_general">
            <i>Reclamación por fuera de tiempo.</i> <br>
            Si el producto es recibido en las instalaciones del cliente a “CONFORMIDAD” y
            han transcurrido (3) tres días hábiles después de la entrega, Eurochem no se
            hace responsable por daños del empaque (sellos rotos, abolladuras, fisuras, entre otros).
            <br>
            Tres días hábiles después de la entrega del producto, Eurochem considera
            que el cliente ha realizado la verificación de los documentos, el pesaje
            y los análisis de control calidad de los productos entregados. Al término
            de este periodo, la compañía no aceptará reclamos por documentación,
            faltantes y especificaciones técnicas.
          </p>
          <p class="text_general">
            <i>Soportes Insuficientes para la reclamación.</i> <br>
            Cuando el cliente no suministra las evidencias suficientes para soportar la
            reclamación, Eurochem puede considerar el reclamo como “NO PROCEDENTE”.
          </p>
          <p class="text_general">
            Para los diferentes motivos de reclamación, se requiere de la siguiente
            información de soporte:
          </p>
          <div class="col-12">
            <img src="/imagen/politicas1.jpg" alt="" width="100%">
          </div>
          <p class="text_general">
            <strong>NOTA:</strong> Los resultados de análisis expedidos por Eurochem no eximen
            al cliente de la realización de sus propios análisis para validad la calidad
            y aceptación de los productos adquiridos. Eurochem no asume responsabilidad
            por las decisiones de no realizar el control de calidad por parte de los
            clientes para la aprobación del uso o venta de los productos adquiridos.
          </p>
        </div>
        <div class="row">
          <h2 class="titulos col-12 text-center">2. FORMULACIÓN DE QUEJAS Y RECLAMOS.</h2>
        </div>
        <div class="row mt-2">
          <p class="text_general">
            Eurochem ha clasificado la formulación y atención de Quejas y
            Reclamos bajo los siguientes conceptos:
          </p>
          <div class="col-12">
            <img src="/imagen/politicas2.jpg" alt="" width="100%">
          </div>
          <p class="text_general">
            A continuación se presentan las causales de reclamación bajo cada concepto:
          </p>
          <p class="text_general">
            <strong>Consideración General:</strong> <br>
            <i>Es importante que el cliente realice la inspección física del producto
              dentro de los 3 días hábiles siguientes a la recepción, incluido el
              día de entrega. Cualquier queja o reclamo por cualquier concepto recibido
              fuera del tiempo establecido, no será aceptado por Eurochem.</i>
            </p>
        </div>
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.1 Atención</h4>
          <p class="text_general">
            Insatisfacción con la atención recibida o la prestación del servicio
            por parte del personal de Eurochem (comercial, logística, calidad).
          </p>
          <p class="text_general">
            Insatisfacción con la atención recibida durante la entrega del producto
          ...
          <p class="text_general">
            Transferencia de llamadas sin verificación de la disponibilidad de
            la persona que debe recibir.
          </p>
          <p class="text_general">
            Demora en respuesta telefónica a inquietudes o solicitudes del cliente.
          </p>
          <p class="text_general">
            Demora en la atención para los clientes que recogen producto en las
            instalaciones de Eurochem, siempre y cuando la demora sea por
            causa de Eurochem y no por incumplimientos por parte del vehículo
            en condiciones de seguridad y ambiente, u otras condiciones por parte del cliente.
          </p>
        </div>
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.2 Facturación</h4>
          <p class="text_general">
            Entrega de una factura donde la información del producto, las cantidades facturadas o su precio, no
            correspondan a los pactados en la orden de compra del cliente o la toma del pedido.
            <br><br>
          ...
          <hr>
          <p class="text_general">
            <strong>Acciones frente al reclamo:</strong> <br>
            Cuando existan diferencias entre el producto pedido y el producto facturado, se procederá a la
            debida investigación que permita identificar si se requiere cambio de producto y/o cambio de
            documentación. <br>
            Cuando las diferencias se presenten en las cantidades o precios facturados se realizará la
            investigación para determinar con el cliente la anulación de la factura o la elaboración de la nota
            contable correspondiente.
          </p>
        </div>
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.3 Cartera.</h4>
          <p class="text_general">
        ...
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.4 Tiempo de Entrega.</h4>
          <p class="text_general">
          ...
          <p class="text_general">
            ...
            No se consideran las reclamaciones por demoras en el ingreso a instalaciones del cliente por causa
            de procedimientos internos o congestión donde el cliente.
          </p>
        </div>
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.5 Documentación.</h4>
          <p class="text_general">
          ...
          <p class="text_general">
            <strong>Consideraciones:</strong> <br>
            El cliente debe informar a Eurochem si existen requisitos especiales de documentación. No se consideran las
            reclamaciones por documentación no solicitada previamente.
          </p>
          <p class="text_general">
            <strong>Acciones frente al reclamo:</strong> <br>
            El cliente debe informar a Eurochem si existen requisitos especiales de documentación. No se consideran las
        ...
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.6 Condiciones SST y Gestión ambiental.</h4>
          <p class="text_general">
          ...
          <p class="text_general">
            ...
            El cliente debe informar a Eurochem si existen requisitos especiales de cumplimiento en Seguridad y Salud en el trabajo, o en Gestion Ambiental.
            <br><br>
        ...
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.7 Faltantes.</h4>
          <p class="text_general">
            <strong>Producto Granel.</strong> En el caso en que la diferencia entre el peso neto real del producto y la cantidad facturada en entregas a granel, sobrepase el ±0.5 % de la cantidad reportada por Eurochem y sobrepase la tolerancia de ambas básculas para el peso bruto determinado.
          </p>
          <p class="text_general">
            <strong>Producto Empacado.</strong> Cuando la diferencia entre el peso neto real del producto y la cantidad reportada en la etiqueta correspondiente, sobrepase el ±0.5 % de la cantidad reportada por Eurochem “por unidad de empaque”.
          </p>
          <p class="text_general">
            <strong>Consideraciones:</strong> <br>
            ...
            <br><br>
            El pesaje por parte del cliente de los productos empacados, deberá hacerse en una báscula de clase de precisión igual o superior a las básculas de Eurochem (Clase de precisión III) y deberá contar con protocolo de calibración vigente, emitido por una compañía acreditada por la Superintendencia de
            Industria y Comercio y con trazabilidad a patrones de peso nacionales.
            <br><br>
        ...
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.8 Presentación.</h4>
          <p class="text_general">
        ...
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.9 Contaminación</h4>
          <p class="text_general">
        ...
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.10 Especificaciones técnicas del producto.</h4>
          <p class="text_general">
          ...
          <p class="text_general">
            ...
            <br><br>
            Si el producto es clasificado como fuera de especificaciones por el cliente, éste deberá ser aislado hasta que Eurochem no emita el concepto técnico correspondiente.
            Eurochem se reserva el derecho de asumir responsabilidades o costos cuando el producto haya sido manipulado por el cliente o cuando haya sido usado sin realizar los chequeos previos de control calidad.
            <br><br>
        ...
        <div class="row mt-3">
          <h4 class="titulos_blog col-12 text-center">2.11 Especificaciones Material de Empaque.</h4>
          <p class="text_general">
            ...
            <br><br>
            Cuando se realicen cobros de material de empaque que ya fue gestionado y Eurochem no descargue a tiempo en sus inventarios.
            <strong>Consideraciones:</strong><br>
        ...
        <div class="row">
          <h2 class="titulos col-12 text-center">3. EVALUACIÓN Y RECONOCIMIENTO DE RECLAMOS</h2>
        </div>
        <div class="row mt-2">
          <p class="text_general">
          ...
          <p class="text_general">
            <strong><i>Acciones adicionales:</i></strong><br>
            <strong>Cobro de producto.</strong><br>
            ...
            <br>
            <strong>Cobro de material empaque.</strong><br>
