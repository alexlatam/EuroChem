    ...
    <div class="row px-4 mb-2">
      <div class="col-12 col-md-6 col-lg-3">
        ...
        <div class="row pr-4 mt-2">
          <p class="text-center text-md-left" style="color:#fff;opacity:0.7;">We retail raw material for industry, generating value for our providers, clients, employees and investors.</p>
        </div>
        <div class="row">
      ...
      <div class="d-none d-md-block col-md-6 col-lg-3 mt-4 mt-sm-0">
        <div class="row justify-content-center justify-content-sm-start">
          <h6 class="title_footer pt-3">Privacy & Policy</h6>
        </div>
        <div class="row justify-content-center justify-content-sm-start mt-2">
          <a class="enlace_footer mb-2 text-center text-sm-left" href="/en/data-protection/">Data Protection</a>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer text-center text-sm-left" href="/en/complaints-and-return-policies/">Complaints and Return Policies</a>
        </div>
      </div>
      <div class="d-none d-md-block col-md-6 col-lg-3 text-center text-sm-left mt-4 mt-sm-0">
        <div class="row justify-content-center justify-content-sm-start">
          <h6 class="title_footer pt-3">Contact Us</h6>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
        ...
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer mb-2" href="mailto:ventas@eurochemus.com">
            ...
            ventas@eurochemus.com
          </a>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer mb-2" href="/en/contact-us/">
            <svg class="mr-2" aria-hidden="true" width="14" focusable="false" data-prefix="fas" data-icon="map-marker-alt" class="svg-inline--fa fa-map-marker-alt fa-w-12" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="currentColor" d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z"></path></svg>
            Our branches
          </a>
        </div>
      </div>
      <div class="d-none d-md-block col-md-6 col-lg-3 text-center text-sm-left mt-4 mt-sm-0">
        <div class="row justify-content-center justify-content-sm-start">
          <h6 class="title_footer pt-3">Site Map</h6>
        </div>
        <div class="row justify-content-center justify-content-sm-start mt-2">
          <a class="enlace_footer" href="/en/products/index.php?products=1">Divisions</a>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer" href="/en/products/index.php?industries=1">Industries</a>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer" href="/en/certifications/">Certifications</a>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer" href="/en/in-the-news/">In The News</a>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer" href="/en/work-opportunities/">Work Opportunities</a>
        </div>
        <div class="row justify-content-center justify-content-sm-start">
          <a class="enlace_footer" href="/en/our-company/">Our Company</a>
        </div>
      </div>
    </div>
    <div class="row px-5 justify-content-center">
      <small class="mb-3" style="color:#fff;opacity:0.4;">Eurochem. All rights are reserved 2020.</small>
    </div>
  </div>
</section>
