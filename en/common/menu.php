<div class="py-3">
    ...
    <div class="row align-items-center">
      <div class="col-auto">
        ...
        <div class="dropdown_menu_email">
          ...
          <small class="dropdown-content_menu_email">
            <a href="mailto:ventas@eurochemus.com">ventas@eurochemus.com</a>
          </small>
        </div>
      </div>
      <div class="col-auto d-none d-md-block">
        <span class="px-1">
          <a class="enlace_menu <?php if($section=="certificaciones"){echo "active";} ?>" href="/en/certifications/">Certifications</a>
        </span>
        <span class="px-1">
          <a class="enlace_menu <?php if($section=="trabaje"){echo "active";} ?>" href="/en/work-opportunities/">Work Opportunities</a>
        </span>
        <span class="px-1">
          <a class="enlace_menu <?php if($section=="actualidad"){echo "active";} ?>" href="/en/in-the-news/">In The News</a>
        </span>
      </div>
      <div class="col-auto ml-auto">
        ...
        <div class="dropdown_menu">
          <img class="dropdown-item-icon ml-3 mr-0" src="/imagen/spain.svg" alt="SVG">
          <span class="dropbtn_menu">Spanish</span>
  ...
  <div class="cont_input_search">
    ...
    <input class="search_input_menu" type="search" hidden name="search" placeholder="Search products..." onkeypress="if (event.keyCode == 13) enviar_formulario()" id="input_search_menu">
  </form>
  </div>
</div>
<script>
