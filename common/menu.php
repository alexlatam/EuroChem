    ...
    <div class="row align-items-center">
      ...
      <div class="col-auto" style="font-family:'Roboto Condensed',sans-serif;">
        <span class="border_rigth px-1">
          <a class="enlace_menu <?php if($section=="certificaciones"){echo "active";} ?>" href="<?php if($section!="certificaciones" && $section!="home"){echo "../";} ?>certificaciones/">Certificaciones</a>
        </span>
        <span class="border_rigth px-1">
          <a class="enlace_menu <?php if($section=="sustentabilidad"){echo "active";} ?>" href="<?php if($section!="sustentabilidad" && $section!="home"){echo "../";} ?>sustentabilidad/">Sustentabilidad</a>
        </span>
        <span class="border_rigth px-1">
          <a class="enlace_menu <?php if($section=="trabaje"){echo "active";} ?>" href="<?php if($section!="trabaje" && $section!="home"){echo "../";} ?>trabaje/">Trabaje con nosotros</a>
        </span>
        <span class="border_rigth px-1">
          <a class="enlace_menu <?php if($section=="actualidad"){echo "active";} ?>" href="<?php if($section!="actualidad" && $section!="home"){echo "../";} ?>actualidad/">Actualidad</a>
        </span>
      </div>
