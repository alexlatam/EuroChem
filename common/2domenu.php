  ...
  <div class="container my-0">
    ...
    <ul class="navbar-nav ml-3">
      <li class="nav-item active pt-2">
        <a class="nav-link text_menu_2 active py-4" href="#">Inicio</a>
      </li>
      <li class="nav-item ml-3 pt-2">
        <div class="dropdown">
          <a class="nav-link dropbtn text_menu_2 py-4" href="#">Divisiones</a>
      ...
      <li class="nav-item ml-3 pt-2">
        <a class="nav-link text_menu_2 py-4" href="#">Industrias</a>
      </li>
      <li class="nav-item ml-3 pt-2">
        <a class="nav-link text_menu_2 py-4" href="#">Nuestra compañía</a>
      </li>
      <li class="nav-item ml-3 pt-2">
        <a class="nav-link text_menu_2 py-4" href="#">Pagos en línea</a>
      </li>
      <li class="nav-item ml-3 pt-2">
        <a class="nav-link text_menu_2 py-4" href="#">Contáctenos</a>
      </li>
    </ul>
  </div>
  </div>
