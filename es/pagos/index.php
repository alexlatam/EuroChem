...
<head>
  ...
  <script src="../../assets/vendor/owlcarousel/owl.carousel.min.jss"></script>
          ...
          <div class="col-12 col-md-8">
            <div class="row">
              <div class ="col-12 text-center pb-2 px-0">
                <h4 class="text-primary"><strong>INGRESO A PAGO EN LÍNEA</strong></h4>
              </div>
            </div>
            <div class="row px-5">
            ...
            <div class="row mb-4 px-5">
              <div class="col-12 px-0">
                <button class="btn btn-primary px-4 input_search" type="button"><b>Ingresar</b></button>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="row px-4 bg-primary m-2">
              <div class="col-12 my-3 pl-2">
                <h class="text-light h5"><strong>INFORMACIÓN</strong></h6>
              </div>
              <div class="col-12 mb-5 pl-5 text-justify">
                <span class='text-light' style="font-family: 'Roboto Condensed', sans-serif;">Pagos en línea le permite <b class="">consultar</b> el histórico de sus <b class="">documentos transaccionales</b>.</span>
              </div>
            </div>
          </div>
        </div>
