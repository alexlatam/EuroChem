  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-auto d-none d-md-block" style="font-family:'Roboto Condensed',sans-serif;">
        ...
        <span class="border_rigth px-1">
          <a class="enlace_menu <?php if($section=="sustentabilidad"){echo "active";} ?>" href="/es/sustentabilidad/">Sustentabilidad</a>
        </span>
        <span class="border_rigth px-1">
      ...
      <div class="col-auto ml-auto d-none d-sm-block">
        <form action="/es/productos/index.php" method="get" id="search1">
          <input class="form-control search_input" type="search" name="search" placeholder="Buscar productos..." onkeypress="if (event.keyCode == 13) enviar_formulario()">
        </form>
      </div>
    </div>
  </div>
